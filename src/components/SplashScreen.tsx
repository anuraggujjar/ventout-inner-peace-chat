...
export const SplashScreen = ({ onComplete }: SplashScreenProps) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center transition-all duration-700 ease-in-out ${
      isAnimating 
        ? 'bg-gradient-to-br from-primary/5 via-background to-secondary/5 opacity-100' 
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(12)].map((_, i) => (
          <div
            key={i}
            className={`absolute w-2 h-2 bg-primary/10 rounded-full animate-bounce ${
      ...
      <div className="text-center relative z-10">
        <div className={`transform transition-all duration-1000 ease-out ${
          ...
          <h1 className="text-7xl font-bold bg-gradient-to-r from-primary/50 via-secondary/60 to-accent/50 bg-clip-text text-transparent">
            Plaro
          </h1>
        ...
        <div className={`mt-6 transform transition-all duration-1000 delay-500 ease-out ${
          ...
          <div className="mt-8 w-32 h-1 bg-muted rounded-full mx-auto overflow-hidden">
            <div className={`h-full bg-gradient-to-r from-primary/50 to-secondary/60 rounded-full transition-transform duration-2000 ease-out ${
        ...
        <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ${
          ...
          <div className="w-64 h-64 border border-secondary/10 rounded-full" />
        </div>
      </div>
    </div>
  );
